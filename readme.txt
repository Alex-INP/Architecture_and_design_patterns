...
- Тег "[# childof 'your_template_path' #]".
    ...
    Пример: [# childof 'mytmpldir/template.html' #]
...
- Тег "[# insert 'your_template_path' #]".
    ...
    Указывать your_template_path следует по тому же принципу, что и в случае с тегом [# childof 'your_template_path' #],
    тоесть как в контроллерах.
